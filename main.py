...
def main():
    ...
    for baseJudgment in baseJudgments:
        caseDetail = ObtainCaseDetails.parseReponse(baseJudgment.unicourtCaseId)
        baseJudgment.addDocketToken(caseDetail.DocketToken)
        baseJudgment.addParties(caseDetail.PartyInfo)
